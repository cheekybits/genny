...
[![Build Status](https://travis-ci.org/falun/genny.svg?branch=master)](https://travis-ci.org/falun/genny) [![GoDoc](https://godoc.org/github.com/falun/genny/parse?status.png)](http://godoc.org/github.com/falun/genny/parse)
...
go get github.com/falun/genny
go test github.com/falun/genny/...
```
...
We have started building a [library of common things](https://github.com/falun/gennylib), and you can use `genny get` to generate the specific versions you need.
...
To see a real example of how to use `genny` with `go generate`, look in the [example/go-generate directory](https://github.com/falun/genny/tree/master/examples/go-generate).
...
Given [this generic Go code](https://github.com/falun/genny/tree/master/examples/queue) which compiles and is tested:
...
Check out the [test code files](https://github.com/falun/genny/tree/master/parse/test) for more real examples.
...
### Contributions
  ...
  * See the [API documentation for the parse package](http://godoc.org/github.com/falun/genny/parse)
  * Please do TDD
  * All input welcome
